...
def make_manifest(
    ...
    *,
    ...
    output_materialized_bytes: int | None = None,
    output_materialized_mb: float | None = None,
    ...
    return {
        ...
        "output_materialized_bytes": output_materialized_bytes,
        "output_materialized_mb": output_materialized_mb,
